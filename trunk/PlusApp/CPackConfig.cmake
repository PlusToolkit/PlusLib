...
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "PerkLab Ultrasound Applications")
...
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "PlusApp_${CPACK_PACKAGE_VERSION_MAJOR}.${CPACK_PACKAGE_VERSION_MINOR}.${CPACK_PACKAGE_VERSION_PATCH}.${PLUSAPP_REVISION}")
...
IF(EXISTS "${PLUS_DIR}/CMakeCache.txt")
  SET(CPACK_INSTALL_CMAKE_PROJECTS "${CPACK_INSTALL_CMAKE_PROJECTS};${PLUS_DIR};PLUS;RuntimeLibraries;/")
  SET(CPACK_INSTALL_CMAKE_PROJECTS "${CPACK_INSTALL_CMAKE_PROJECTS};${PLUS_DIR};PLUS;Scripts;/")
ELSE(EXISTS "${PLUS_DIR}/CMakeCache.txt")
    MESSAGE(WARNING "Unable to set PLUS_DIR for package generation!")
ENDIF(EXISTS "${PLUS_DIR}/CMakeCache.txt")
