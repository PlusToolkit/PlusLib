...
// .SECTION Description
// vtkUltrasoundDataCollector will incrementally compound ultrasound images into a
...
// template <class F, class T>
// static void vtkGetUltraInterpFunc(vtkUltrasoundDataCollector *self, 
...
static char *vtkUltrasoundDataCollectorEatWhitespace(char *text)
{
  int i = 0;
...
//----------------------------------------------------------------------------
// Eats leading whitespace
static char *vtkUltrasoundDataCollectorEatWhitespaceWithEquals(char *text)
{
  int i = 0;
...
int vtkExtractArrayComponentsFromString(char *text, T *arrayToFill, int numIndices)
  ...
  text = vtkUltrasoundDataCollectorEatWhitespace(text);
  ...
  for (int i = 0; i < numIndices; i++)
    ...
    result = vtkUltrasoundDataCollectorEatWhitespace(result);
...
// filter)
template <class T>
static void vtkUltrasoundDataCollectorInsertSlice(vtkUltrasoundDataCollector *self,
...
template <class F, class T>
static void vtkOptimizedInsertSlice(vtkUltrasoundDataCollector *self, // the freehand us
...
static void *vtkReconstructionThread(ThreadInfoStruct *data)
{
  ...
  vtkUltrasoundDataCollector *self = (vtkUltrasoundDataCollector *)(data->UserData);
