...
#include "ui_QConfigurationToolbox.h"
...
* \ingroup PlusAppFCal
*/
class QConfigurationToolbox : public QWidget, public QAbstractToolbox
{
  Q_OBJECT
...
public:
  ...
  */
  QConfigurationToolbox(fCalMainWindow* aParentMainWindow, Qt::WindowFlags aFlags = 0);

  /*!
  * Destructor
  */
  ~QConfigurationToolbox();
