...
class CompareTransforms:
  def __init__(self, parent):
    parent.title = "Compare transforms"
    parent.categories = ["IGT"]
    parent.dependencies = []
    parent.contributors = ["Andras Lasso (PerkLab, Queen's)"]
    parent.helpText = "Compute statistics on the difference between two transforms"
    parent.acknowledgementText = ""
    self.parent = parent

#
# qCompareTransformsWidget
#

class CompareTransformsWidget:
  def __init__(self, parent = None):
    ...
    self.logic = CompareTransformsLogic()
  ...
  def setup(self):
    ...
    self.reloadButton.name = "CompareTransforms Reload"
    ...
    averageFormLayout.addRow(self.groundTruthTransformSelectorLabel, self.groundTruthTransformSelector)     
    ...
    averageFormLayout.addRow(self.mappedTransformSelectorLabel, self.mappedTransformSelector)     
    ...
    averageFormLayout.addRow(self.outputVisitedPointsModelSelectorLabel, self.outputVisitedPointsModelSelector)
    ...
    averageFormLayout.addRow(self.outputTransformSelectorLabel, self.outputTransformSelector)
    ...
    averageFormLayout.addRow("Enable mapping", self.enableTransformMappingCheckBox)
  ...
  def onReload(self,moduleName="CompareTransforms"):
  ...
  def onReloadAndTest(self,moduleName="CompareTransforms"):
    try:
      self.onReload()
...
#
# CompareTransformsLogic
#

class CompareTransformsLogic:
