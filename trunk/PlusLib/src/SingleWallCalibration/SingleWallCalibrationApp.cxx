...
int main(int, char *[])
{
  ...
  if( !fin1.is_open() || !fin2.is_open() || !fin3.is_open() || !fin4.is_open() || !fin5.is_open() || !fin6.is_open() )
  {
    LOG_ERROR("Unable to open source files.");
    return EXIT_FAILURE;
  }
...
//................ Reading x_center; y_center and "m=slope of line".........
  ...
  LOG_INFO("Estimated Translation: " << t_IP_est[0] << " " << t_IP_est[1] << " " << t_IP_est[2] );
  LOG_INFO("Estimated n:" << n_est[0] << " " << n_est[1] << " " << n_est[2]);
  LOG_INFO("Estimated d (parameter of the plane) : " << d_est);
