...
vtkSmartPointer<vtkCriticalSection> gCritSec = vtkSmartPointer<vtkCriticalSection>::New();
  ...
  while ( !gStopRequested )
  {
    ...
    else
    {
      ...
      if (vtkPlusLogger::Instance()->GetLogLevel()>=vtkPlusLogger::LOG_LEVEL_DEBUG
        || vtkPlusLogger::Instance()->GetDisplayLogLevel()>=vtkPlusLogger::LOG_LEVEL_DEBUG)
      {
