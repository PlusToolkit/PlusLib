...
int main(int argc, char **argv)
{
  ...
  if( vtkSequenceIOCommon::Read(inputFixedSequenceMetafile, fixedFrames) != PLUS_SUCCESS )
  {
  ...
  if( vtkSequenceIOCommon::Read(inputMovingSequenceMetafile, movingFrames) != PLUS_SUCCESS )
  {
