...
//----------------------------------------------------------------------------
vtkPlusToolAxesActor::AxisInfo::AxisInfo()
{
  // Shaft
...
//----------------------------------------------------------------------------
void vtkPlusToolAxesActor::AxisInfo::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------------
int vtkPlusToolAxesActor::RenderOpaqueGeometry(vtkViewport *vp)
{
...
//-----------------------------------------------------------------------------
int vtkPlusToolAxesActor::RenderTranslucentPolygonalGeometry(vtkViewport *vp)
{
  int renderedSomething = 0;
...
//-----------------------------------------------------------------------------
int vtkPlusToolAxesActor::RenderOverlay(vtkViewport *vp)
{
  int renderedSomething = 0;
...
//----------------------------------------------------------------------------
void vtkPlusToolAxesActor::ExtendMaxBounds(vtkActor *actor, double* bounds)
{
...
void vtkPlusToolAxesActor::UpdateProps()
{
  ...
  {
    LOG_ERROR("vtkPlusToolAxesActor UserTransform is invalid");
    return;
  }
...
//----------------------------------------------------------------------------
void vtkPlusToolAxesActor::PrintSelf(ostream& os, vtkIndent indent)
{
