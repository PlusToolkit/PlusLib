...
//----------------------------------------------------------------------------
int vtkPlusOpenIGTLinkClient::ConnectToServer()
{
...
//----------------------------------------------------------------------------
int vtkPlusOpenIGTLinkClient::StartDataCollector()
{
  return 0;
}

//----------------------------------------------------------------------------
int vtkPlusOpenIGTLinkClient::StopDataCollector()
{
  return 0;
}

//----------------------------------------------------------------------------
bool vtkPlusOpenIGTLinkClient::SendCommand( vtkPlusCommand* command )
{  
