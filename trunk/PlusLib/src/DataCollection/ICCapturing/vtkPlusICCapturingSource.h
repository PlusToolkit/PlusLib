...
class vtkDataCollectionExport vtkPlusICCapturingSource;
...
*/
class vtkDataCollectionExport vtkPlusICCapturingSourceCleanup
{
public:
...
\ingroup PlusLibDataCollection
*/
class vtkDataCollectionExport vtkPlusICCapturingSource : public vtkPlusDevice
{
public:
