...
int main(int argc, char **argv)
{
  ...
  args.AddArgument("--grabber-location", vtksys::CommandLineArguments::EQUAL_ARGUMENT, &grabberLocation, "Location of the of the BK device to connect (use the format sn:SERIAL for the specification of serial number)");
