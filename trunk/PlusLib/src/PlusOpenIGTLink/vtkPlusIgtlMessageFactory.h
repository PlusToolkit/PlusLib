...
public:
  ...
  */ 
  PlusStatus PackMessages(bool packValidTransformsOnly, const std::vector<std::string>& igtlMessageTypes, std::vector<igtl::MessageBase::Pointer>& igtMessages, TrackedFrame& trackedFrame, 
