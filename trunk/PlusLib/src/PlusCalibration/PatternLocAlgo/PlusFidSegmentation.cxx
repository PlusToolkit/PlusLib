...
void PlusFidSegmentation::SetFrameSize(int frameSize[2])
{
...
int PlusFidSegmentation::GetMorphologicalOpeningBarSizePx()
{
...
void PlusFidSegmentation::Erode0( PlusFidSegmentation::PixelType *dest, PlusFidSegmentation::PixelType *image )
{
  ...
  for ( unsigned int ir = m_RegionOfInterest[1]; ir < m_RegionOfInterest[3]; ir++ )
  {
    ...
    PlusFidSegmentation::PixelType dval = ErodePoint0( image, ir, ic ); // find lowest pixel intensity in surroudning region ( postions +/- 8 of current pixel position) 
...
void PlusFidSegmentation::SetRegionOfInterest(int xMin, int yMin, int xMax, int yMax)
{
...
//-----------------------------------------------------------------------------
void PlusFidSegmentation::GetRegionOfInterest(int &xMin, int &yMin, int &xMax, int &yMax)
{
