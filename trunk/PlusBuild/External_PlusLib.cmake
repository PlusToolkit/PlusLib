...
IF (PLUSBUILD_USE_OpenIGTLinkIO)
  SET(PLUSBUILD_ADDITIONAL_SDK_ARGS ${PLUSBUILD_ADDITIONAL_SDK_ARGS}
...
IF( PLUS_USE_OvrvisionPro )
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS -DOvrvisionPro_DIR:PATH=${PLUS_OvrvisionPro_DIR})
ENDIF()
...
ExternalProject_Add(PlusLib
  ...
  SVN_REPOSITORY https://subversion.assembla.com/svn/plus/${PLUSBUILD_SVN_BRANCH}/PlusLib
