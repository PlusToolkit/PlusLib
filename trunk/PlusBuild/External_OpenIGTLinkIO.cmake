...
ELSE()
  ...
  ExternalProject_Add( OpenIGTLinkIO
    ...
    CMAKE_ARGS 
        ...
        -DCMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG:STRING=${PLUS_EXECUTABLE_OUTPUT_PATH}/Debug
        -DCMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE:STRING=${PLUS_EXECUTABLE_OUTPUT_PATH}/Release
        -DCMAKE_LIBRARY_OUTPUT_DIRECTORY:STRING=${PLUS_EXECUTABLE_OUTPUT_PATH}
        -DCMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG:STRING=${PLUS_EXECUTABLE_OUTPUT_PATH}/Debug
        -DCMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE:STRING=${PLUS_EXECUTABLE_OUTPUT_PATH}/Release
