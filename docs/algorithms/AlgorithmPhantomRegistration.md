...
### Configuration settings
  ...
  - **vtkPlusPhantomLandmarkRegistrationAlgo**
    ...
    - **StylusTipCoordinateFrame** (Required)
    - **AcquisitionRate** (Optional, default: `20`)
    - **FilterWindowTimeSec** (Optional, default: `0.2`)
    - **DetectionTimeSec** (Optional, default: `1.0`)
    - **StylusShaftMinimumDisplacementThresholdMm** (Optional, default: `30`)
    - **StylusTipMaximumDisplacementThresholdMm** (Optional, default: `1.5`)
