...
The application configuration file is an XML file with the following root element:
  - **PlusConfig**
    - **LogLevel**: Logging level. See more information on the \subpage FileLog page.
    ...
    - **DeviceSetConfigurationDirectory**: Device set configuration files will be searched relative to this directory (    - **ImageDirectory**: Sequence metafiles (    - **ModelDirectory**: Model files (    - **ScriptsDirectory**: Directory of scripts that application may need.