...
## Device configuration settings
  ...
  - **DeviceType**: (`Type`) = `(`OvrvisionPro`)` (Required)


  - **DirectShowFilterID**: Defines the filter ID that corresponds to this device. Windows Only.
  - **Resolution**: and **Framerate** define the requested capture format of the camera. Typical value is "640x480@30". Supported values are
