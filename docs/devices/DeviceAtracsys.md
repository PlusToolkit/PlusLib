...
## Device configuration settings
  ...
  - **DataSources**: (Required)
    - **DataSource**: (Required)
    - **TrackingType**: The type of marker this is. (    - `ACTIVE`
    - `PASSIVE`

    - **GeometryFile**: If this is a PASSIVE marker, provide the GeometryFile attribute with the path to the markers geometry file
    - **GeometryId**: If the marker is an ACTIVE marker, provide the Atracsys assigned Id of the marker. (## Config File
