...
## Device configuration settings
  ...
  - **ProjectFile**: The Motive project file
  - **AttachToRunningMotive**: Set to TRUE to make Plus connect to an already running instance of Motive application
  ...
  - **DataSources**: One `DataSource` child element is required for each rigid body to be tracked. (Required)
     - **DataSource**: (Required)
      ...
      - **Id**: The rigid body name. The same name should be assigned to the rigid body in Motive.
      - **RigidBodyFile**: The filename of the TRA file that defines the rigid body. ## Simple Configuration
