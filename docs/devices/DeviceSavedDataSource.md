...
## Device configuration settings
  ...
  - **DeviceType**: (`Type`) = `(`SavedDataSource`)` (Required)
  - **DeviceAcquisitionRate**: (`AcquisitionRate`) (Optional, default: 10)
  ...
  - **RepeatEnabled**: Flag to enable saved dataset looping. If it's enabled, the video source will continuously play saved data
  - **UseOriginalTimestamps**: Flag to read the timestamps from the file and use them in the output
