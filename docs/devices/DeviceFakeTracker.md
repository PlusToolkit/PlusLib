...
## Device configuration settings
  ...
  - **DeviceType**: (`Type`) = `(`FakeTracker`)` (Required)
  - **DeviceAcquisitionRate**: (`AcquisitionRate`) (Optional, default: 30) 
  ...
  - **PhantomDefinition**: (Required) if **Mode** = `(`RecordPhantomLandmarks`).`
