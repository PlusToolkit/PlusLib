...
## Device configuration settings
  ...
  - **Device
    - **DeviceType**: (`Type`) = `(`VirtualTextRecognizer`)` (Required)
    - **\anchor Language **Language** Language to be recognized. (Optional, default: eng) 
    ...
    - **TextFields Multiple `Field` child elements are allowed, one for each parameter to recognize (Required)
      ...
      - **InputChannel (Required)
	    - **Id**: The id of this input channel ## Example configuration file PlusDeviceSet_PlusServer_tesseract.xml
