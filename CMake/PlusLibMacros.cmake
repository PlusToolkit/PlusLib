MACRO(PlusLibInstallLibrary _target_name _variable_root)
  ...
  ELSEIF(UNIX AND NOT APPLE)
    INSTALL(TARGETS ${_target_name} EXPORT PlusLib
      RUNTIME DESTINATION "${PLUSLIB_BINARY_INSTALL}" CONFIGURATIONS Release COMPONENT RuntimeLibraries #executables
      LIBRARY DESTINATION "${PLUSLIB_BINARY_INSTALL}" CONFIGURATIONS Release COMPONENT RuntimeLibraries #.so files
      ARCHIVE DESTINATION "${PLUSLIB_ARCHIVE_INSTALL}" CONFIGURATIONS Release COMPONENT Development #.s files
      )
  ENDIF()
