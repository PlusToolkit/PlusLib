...
public:
  ...
  {
    frameGrabber->GetDicomImage(dicomImage);
    viewer->SetInput(dicomImage);
    viewer->Render();
  ...
  vtkStealthLinkTracker *frameGrabber;
...
int main(int argc, char **argv)
{
  ...
  vtkSmartPointer<vtkStealthLinkTracker> frameGrabber = vtkSmartPointer<vtkStealthLinkTracker>::New();
