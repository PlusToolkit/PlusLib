...
vtkPlusCommandCollection* vtkPlusCommandFactory::AvailableCommands=NULL;
...
//----------------------------------------------------------------------------
void vtkPlusCommandFactory::PrintSelf( ostream& os, vtkIndent indent )
{
...
//----------------------------------------------------------------------------
const char* vtkPlusCommandFactory::GetVTKSourceVersion()
{
  return VTK_SOURCE_VERSION;
}

//----------------------------------------------------------------------------
const char* vtkPlusCommandFactory::GetDescription()
{
  return "VTK PlusCommand Factory";
}

//----------------------------------------------------------------------------
vtkPlusCommandFactory::vtkPlusCommandFactory()
{
...
//----------------------------------------------------------------------------
void vtkPlusCommandFactory::RegisterPlusCommand( vtkPlusCommand* r)
{
...
//----------------------------------------------------------------------------
vtkPlusCommand* vtkPlusCommandFactory::CreatePlusCommand( std::string str )
{
  vtkPlusCommandFactory::InitializeCommands();
  vtkPlusCommand* ret;
...
//----------------------------------------------------------------------------
void vtkPlusCommandFactory::InitializeCommands()
{
  if( vtkPlusCommandFactory::AvailableCommands )
  {
    return;
...
//----------------------------------------------------------------------------
void vtkPlusCommandFactory::GetRegisteredCommands( vtkPlusCommandCollection* collection )
{
  vtkPlusCommandFactory::InitializeCommands();
