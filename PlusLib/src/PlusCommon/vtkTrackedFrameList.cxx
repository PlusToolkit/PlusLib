...
//----------------------------------------------------------------------------
PlusStatus vtkTrackedFrameList::SaveToSequenceMetafile(const char* filename, bool useCompression /*=true*/, bool trackerOnly /*=false*/)
{
  ...
  if (writer->Write(trackerOnly)!=PLUS_SUCCESS)
  {
