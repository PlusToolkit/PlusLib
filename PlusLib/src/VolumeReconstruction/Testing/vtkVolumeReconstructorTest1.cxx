...
{ 
  ...
  reconstructor->SetPixelType( itk::ImageIOBase::UCHAR ); 
  */
  ...
  for ( int frameIndex = 0; frameIndex < numberOfFrames; ++frameIndex )
  {
    ...
    trackedFrameList->GetTrackedFrame(frameIndex)->ImageData.CopyToVtkImage(frameImage);
  ...
  for ( int frameIndex = 0; frameIndex < numberOfFrames; ++frameIndex )
  {
    ...
    mImageToTool->Print( osTransformImageToTool );
