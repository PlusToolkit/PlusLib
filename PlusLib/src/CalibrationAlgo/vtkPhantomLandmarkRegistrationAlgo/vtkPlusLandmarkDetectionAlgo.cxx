...
//----------------------------------------------------------------------------
PlusStatus vtkPlusLandmarkDetectionAlgo::ComputeFilterWindowSize(int & filterWindowSize)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusLandmarkDetectionAlgo::ComputeNumberOfWindows(int & numberOfWindows)
{
