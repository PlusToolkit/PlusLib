...
vtkStandardNewMacro(vtkPlusOptiTrackTracker);

//-----------------------------------------------------------------------
vtkPlusOptiTrackTracker::vtkPlusOptiTrackTracker()
{ 
...
//-------------------------------------------------------------------------
void vtkPlusOptiTrackTracker::PrintSelf( ostream& os, vtkIndent indent )
{
  Superclass::PrintSelf( os, indent );
}

//-------------------------------------------------------------------------
PlusStatus vtkPlusOptiTrackTracker::InternalConnect()
{
  LOG_TRACE( "vtkPlusOptiTrackTracker::Connect" ); 
...
//-------------------------------------------------------------------------
PlusStatus vtkPlusOptiTrackTracker::InternalDisconnect()
{
  LOG_TRACE( "vtkPlusOptiTrackTracker::Disconnect" ); 
...
//-------------------------------------------------------------------------
PlusStatus vtkPlusOptiTrackTracker::InternalUpdate()
{
  LOG_TRACE( "vtkPlusOptiTrackTracker::InternalUpdate" ); 
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusOptiTrackTracker::ReadConfiguration(vtkXMLDataElement* rootConfigElement)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusOptiTrackTracker::WriteConfiguration(vtkXMLDataElement* rootConfigElement)
{
...
//----------------------------------------------------------------------------
void vtkPlusOptiTrackTracker::GetTransformMatrix(std::string toolName, vtkMatrix4x4* transformMatrix)
{
