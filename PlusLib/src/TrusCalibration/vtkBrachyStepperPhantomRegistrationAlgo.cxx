...
PlusStatus vtkBrachyStepperPhantomRegistrationAlgo::Update()
{
  ...
  LOG_INFO("Wire #6 position in phantom (mm): " << this->NWires[1].GetWireById(6)->endPointFront[0] << "   " << this->NWires[1].GetWireById(6)->endPointFront[1]); 
  ...
  double phantomToReferenceDistanceInMm[2] = { 
    this->NWires[1].GetWireById(6)->endPointFront[0] + wire6ToProbeDistanceInMm[0], 
    this->NWires[1].GetWireById(6)->endPointFront[1] + wire6ToProbeDistanceInMm[1] }; 
