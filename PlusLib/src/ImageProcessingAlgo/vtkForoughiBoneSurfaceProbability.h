...
#ifndef vtkForoughiBoneSurfaceProbability_h
#define vtkForoughiBoneSurfaceProbability_h
...
class vtkImageProcessingAlgoExport vtkForoughiBoneSurfaceProbability : public vtkSimpleImageToImageFilter
{
public:
  static vtkForoughiBoneSurfaceProbability *New();
  vtkTypeMacro(vtkForoughiBoneSurfaceProbability,vtkSimpleImageToImageFilter);
...
protected:
  ...
  vtkForoughiBoneSurfaceProbability();
  virtual ~vtkForoughiBoneSurfaceProbability();
...
private:
  vtkForoughiBoneSurfaceProbability(const vtkForoughiBoneSurfaceProbability&);  // Not implemented.
  void operator=(const vtkForoughiBoneSurfaceProbability&);  // Not implemented.
};
