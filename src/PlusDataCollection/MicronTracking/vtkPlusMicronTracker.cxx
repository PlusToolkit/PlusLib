...
PlusStatus vtkPlusMicronTracker::InternalUpdate()
{
  ...
  if (this->MicronTracker->mtGrabFrame() != MT_OK)
  {
  ...
  if (this->MicronTracker->mtProcessFrame() != MT_OK)
  {
...
PlusStatus vtkPlusMicronTracker::GetImage(vtkImageData* leftImage, vtkImageData* rightImage)
{
  ...
  if (!this->MicronTracker->mtGetLeftRightImageArray(leftImageArray, rightImageArray))
  {
