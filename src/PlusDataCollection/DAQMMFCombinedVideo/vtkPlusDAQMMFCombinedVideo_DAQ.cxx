...
{
  vtkSmartPointer<vtkPlusMmfVideoSource> MMFDevice = vtkSmartPointer<vtkPlusMmfVideoSource>::New();
...
void vtkPlusDAQMMFCombinedVideo::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "DAQMMFCombinedVideo: CameraLink Camera" << std::endl;
}
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusDAQMMFCombinedVideo::InternalUpdate()
{
  ...
  {
    LOG_ERROR("vtkPlusDAQMMFCombinedVideo::InternalUpdate Unable to read data");
    return PLUS_SUCCESS; 
  }
  ...
  {
    LOG_DEBUG("vtkPlusDAQMMFCombinedVideo::InternalUpdate Unable to receive frame");
    return PLUS_SUCCESS; 
  }
...
PlusStatus vtkPlusDAQMMFCombinedVideo::NotifyConfigured()
{
  ...
  {
    LOG_ERROR("No output channels defined for vtkPlusDAQMMFCombinedVideo. Cannot proceed.");
