...
public:
  ...
  virtual const std::string& GetInputSeqFilename() const;
  ...
  virtual const std::string& GetOutputVolDeviceName() const { return this->OutputVolDeviceName; }
  ...
  virtual const std::string& GetVolumeReconstructorDeviceId() const;
