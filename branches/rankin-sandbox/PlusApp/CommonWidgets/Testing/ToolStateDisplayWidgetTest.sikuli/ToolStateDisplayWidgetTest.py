...
def getCommandFromArguments(plusDir=''):
  if len(sys.argv) > 1:
    ...
    exe = '"' + plusDir + '/bin/Release/ToolStateDisplayWidgetTest" "--device-set-configuration-dir=' + plusDir + '/PlusLib/data/ConfigFiles/Testing" "--input-config-file-name=' + plusDir + '/PlusLib/data/ConfigFiles/Testing/PlusConfiguration_VideoNone_FakeTracker_ToolState.xml"'
