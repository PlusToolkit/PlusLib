...
#ifndef __vtkPivotCalibrationAutoDetectAlgo_h
#define __vtkPivotCalibrationAutoDetectAlgo_h
...
/*!
  \class vtkPivotCalibrationAutoDetectAlgo 
...
*/
class vtkPivotCalibrationAutoDetectAlgo : public vtkObject
{
public:
  vtkTypeRevisionMacro(vtkPivotCalibrationAutoDetectAlgo,vtkObject);
  static vtkPivotCalibrationAutoDetectAlgo *New();
...
protected:
  vtkPivotCalibrationAutoDetectAlgo();
  virtual  ~vtkPivotCalibrationAutoDetectAlgo();
...
protected:
  ...
  PlusStatus GetPartialPivotPointPosition(double* pivotPoint_Reference);
...
protected:
  ...
  std::list< vtkMatrix4x4* >::iterator CurrentMarkerIterator;
  std::list< vtkMatrix4x4* >::iterator LastMarkerIterator;
