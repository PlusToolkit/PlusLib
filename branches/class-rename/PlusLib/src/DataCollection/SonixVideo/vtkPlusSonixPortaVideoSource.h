...
class vtkDataCollectionExport vtkPlusSonixPortaVideoSource;
class porta;
...
*/
class vtkDataCollectionExport vtkPlusSonixPortaVideoSourceCleanup 
{
public:
...
/*!
  ...
  \ingroup PlusLibDataCollection
*/ 
class vtkDataCollectionExport vtkPlusSonixPortaVideoSource : public vtkPlusDevice {
